<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">Nouveau domaine</h2>
    </x-slot>
            ...
            <div>
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="color" value="{{ $color }}" @checked(old('color', 'blue') === $color) class="sr-only peer">
