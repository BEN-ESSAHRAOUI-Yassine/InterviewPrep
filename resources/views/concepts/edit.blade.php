            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="difficulty" value="{{ $diff }}" @checked(old('difficulty', $concept->difficulty) === $diff) class="sr-only peer">
